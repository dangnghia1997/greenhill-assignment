    ...
    <div class="relative overflow-x-auto shadow-md mx-4">
        <table class="w-full text-sm text-left rtl:text-right text-gray-500">
            ...
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                ...
                <td class="px-6 py-4">
                    <button type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-2 py-1">Update</button>
                </td>
            </tr>
            </tbody>
        </table>
